export default {
  ...
  db = db.slice(0,3);
   ...
   message.reply(`<:K_coin:939160141675262022> **Os Kelionarios do sub mundo de kettra**\n> ${db.map((player, i) => `#${i+1} | 👥 _${client.users.cache.get(player.id).username}_ - <:kerein:994700140256444567> **${abreviar(player.economy.kerein + player.economy.kerein)} KR**`).join("\n> ")}`)
  }
};
