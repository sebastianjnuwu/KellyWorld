...
module.exports = {   
  ...
  let help = new Discord.MessageEmbed()
       ...
       .addFields(
		...
		{ name: 'Veja alguns dos meus comandos clicando [aqui]() são muitos não consigo lembrar de todos.', value: '\u200B' },
		{ name: '<:K_env:938833579981566043> encontrou algum bug? Avise-me [aqui]()', value: '', inline: true },
	)
