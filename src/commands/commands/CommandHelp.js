...
module.exports = {   
  ...
  let help = new Discord.MessageEmbed()
       ...
       .addFields(
		{ name: '<:K_:947545349151653898> Quer ver algumas das coisas que eu fasso?', value: '_"Com grandes poderes vêm grandes responsabilidades_"\n\n<:K_morri:927681449929359410> Veja alguns dos meus comandos clicando [aqui](https://kellyworld.kellyuwu.repl.co/) são muitos não consigo lembrar de todos.' },
	)
